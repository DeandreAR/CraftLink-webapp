  ...
  return (
    <div className="rounded-[18px] border border-neutral-200 bg-white p-4">
      ...
      <button
        ...
        className="mt-4 w-full rounded-xl border border-dashed border-neutral-300 bg-neutral-50 px-4 py-3 text-left text-sm text-neutral-400 line-through decoration-neutral-400"
      >
        {t.strikethrough}
      </button>
