...
export const dashboardEn: DashboardDictionary = {
  ...
  vitrine: {
    ...
    headerAppearance: {
      ...
      layoutTitle: "Header layout",
      layoutStandard: "Standard",
      layoutStandardHint: "Centered photo under a color band.",
      layoutOverlay: "Banner & photo",
      layoutOverlayHint: "Linktree style: tall banner + overlapping avatar.",
      bgTitle: "Header background",
      bgSolid: "Solid color",
      bgGradient: "Gradient",
      bgImage: "Image",
  ...
  partners: {
    ...
    proSelection: {
      title: "Pro Picks",
      hint: "Product / tool recommendations shown in a dedicated tab on your storefront.",
      ...
      formImage: "Image",
      formUrl: "Affiliate link",
      formPrice: "Estimated price",
