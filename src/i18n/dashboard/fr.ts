...
export const dashboardFr: DashboardDictionary = {
  ...
  partners: {
    ...
    proSelection: {
      ...
      save: "Enregistrer",
      cancel: "Annuler",
      empty: "Aucun item — ajoutez un lien Amazon, une affiliation ou une boutique.",
      moveUp: "↑",
      moveDown: "↓",
      formTitle: "Titre",
      ...
      formImage: "Image",
      formUrl: "Lien (URL)",
      formLinkKind: "Type de lien",
      formLinkKindAmazon: "Amazon",
      formLinkKindAffiliate: "Affiliation",
      formLinkKindOther: "Autre (marque / boutique)",
      formActive: "Visible sur la page",
      badgeAmazon: "Amazon",
      badgeAffiliate: "Affiliation",
      uploading: "Envoi…",
      saving: "Enregistrement…",
