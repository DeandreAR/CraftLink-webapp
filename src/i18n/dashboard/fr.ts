...
export const dashboardFr: DashboardDictionary = {
  ...
  vitrine: {
    ...
    headerAppearance: {
      ...
      layoutTitle: "Layout du header",
      layoutStandard: "Standard",
      layoutStandardHint: "Photo centrée sous un bandeau coloré.",
      layoutOverlay: "Bannière & photo",
      layoutOverlayHint: "Style Linktree : bannière haute + avatar chevauchant.",
      bgTitle: "Fond du header",
  ...
  partners: {
    ...
    proSelection: {
      ...
      hint: "Recommandations produits / outillage affichées dans un onglet dédié sur votre vitrine.",
      ...
      formImage: "Image",
      formUrl: "Lien d’affiliation",
      formPrice: "Prix estimé",
