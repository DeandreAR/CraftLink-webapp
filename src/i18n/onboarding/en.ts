...
export const onboardingEn: OnboardingDictionary = {
  ...
  import: {
    ...
    placeholderGoogle: "Exact name of your Google listing",
    placeholderInstagram: "Enter your @username on Instagram",
    placeholderFacebook: "Name of your Facebook page",
